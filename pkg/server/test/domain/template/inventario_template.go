...
func ReporteInventario(items []domain.Inventario, pdfFileName string) error {
	...
	m.AddRow(10,
		...
		col.New(2).Add(text.New("Categoría", props.Text{Style: fontstyle.Bold, Align: align.Center, Size: 10})),
		col.New(2).Add(text.New("Cantidad", props.Text{Style: fontstyle.Bold, Align: align.Center, Size: 10})),
		col.New(1).Add(text.New("Precio", props.Text{Style: fontstyle.Bold, Align: align.Center, Size: 10})),
	...
	for _, item := range items {
		...
		m.AddRow(8,
			col.New(2).Add(text.New(item.ID, props.Text{Align: align.Center, Size: 9})),
			col.New(3).Add(text.New(item.Producto, props.Text{Align: align.Center, Size: 9})),
			col.New(2).Add(text.New(item.Categoria, props.Text{Align: align.Center, Size: 9})),
			col.New(2).Add(text.New(fmt.Sprintf("%d", item.Cantidad), props.Text{Align: align.Center, Size: 9})),
			col.New(1).Add(text.New(fmt.Sprintf("$%.2f", item.Precio), props.Text{Align: align.Center, Size: 9})),
